...
TARGET = "akash.br@pivotchain.com"
# TARGET = "suraj.deshmane@pivotchain.com"
...
LINK = "http://172.105.51.152:5000/image?type=12255"
# LINK = "http://172.105.51.152:1005/test.html"
# LINK = "https://pivotchain.in/cctv_map"
...
<html>
  ...
  <body>
    <p>Test Email!<br>
       How are you? <br>
        # <img src="{0}" onError="alert("h")">
        <p>https://pivotchain.in/img/Raven-logo.png</p>
    </p>
  </body>
</html>
"""
